...
def alta_pedido_simple_m(dni_cliente_i, precio_total_i, estado_i, fecha_obj_i, canal_compra_i, nro_pedido_compuesto_i):
    ...
    if nro_pedido_compuesto_i:
        ...
        item = {
            #"_id" : "U1IT00001",
            "precio_total" : precio_total_i,
            "estado" : estado_i,
            "fecha" : fecha_obj_i,
            "canal_compra" : canal_compra_i,
            "nro_pedido_compuesto" : None,
            "dni_cliente" : dni_cliente_i 
        }
...
if __name__ == "__main__":   
    ...
    print("hola0")
    alta_pedido_simple_m(12345678,20,'pendiente', date.today(), 'web', None)
